                ...
                <div class="row">
                        ...
                        <aside class="services-sidebar">
                            <div class="services-widget mb-40">
                                ...
                                <ul>
                                        ...
                                        <li>
                                            <a class="dropdown-toggle" >Issuance of official certificates</a>
                                            <ul class="dropdown-menu">
                    ...
                    <div class="col-lg-8">
                        <div class="services-details-content">
                            <h4>Application</h4>
                            <p>Here you can <a class="text-danger" href="https://tforms.ages.at/bavg/amtliche-bescheinigungen/formular" title="Antragsstellung zur Ausstellung amtlicher Bescheinigungen und Beglaubigungen ">apply for the issue of official certificates or authentications</a>.</p>
